...
- В качестве инструмента для тестирования API задействован [Postman](https://www.postman.com/). Коллекция тестовых запросов приведена в виде экспортированного в формате "Collection v2.1" JSON-файла `API test requests.postman_collection.json` в корне проекта.
