...
## Техническое задание
Сформированное на основе формального описания задачи техническое задание: [PDF](https://github.com/jasper7466/Study-APS-Task3/Rev.1.1.pdf)

## Проектирование базы данных
Изображения моделей, получившизся в ходе проектирования базы данных:
